...
const COLLECTION_RULES = Object.freeze({
  ...
  "stopwatch-directions": Object.freeze({ fixedIds: new Set(["current"]) }),
  "stopwatch-records": Object.freeze({ pattern: /^stopwatch-[A-Za-z0-9_-]{1,230}$/ }),
  "elimination-settings": Object.freeze({ fixedIds: new Set(["current"]) }),
  "elimination-records": Object.freeze({ pattern: /^elimination-[A-Za-z0-9_-]{1,228}$/ }),
