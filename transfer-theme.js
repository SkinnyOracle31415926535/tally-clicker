...
(() => {
  ...
  const titles = ".ryan-transfer-card h2, .ryan-v3-recovery-card h2";
  const statusPanels = [
    ".ryan-transfer-status", ".ryan-transfer-preview", ".ryan-transfer-recovery", ".ryan-transfer-sync",
    ".ryan-v3-recovery-card [data-status]",
  ].join(", ");
  const actionRows = ".ryan-transfer-actions, .ryan-v3-recovery-actions";
  ...
  function applyTheme() {
    ...
    style.textContent = `
      ...
      .ryan-transfer-card > header,.ryan-v3-recovery-card > header{display:flex!important;align-items:flex-start!important;justify-content:space-between!important;gap:10px!important}
      .ryan-transfer-card > header h2,.ryan-v3-recovery-card > header h2{min-width:0!important}
      .ryan-transfer-actions,.ryan-v3-recovery-actions,.ryan-transfer-conflict-actions{gap:10px!important}
      ${statusPanels}{margin-top:0!important;text-align:left!important;line-height:1.15!important}
      .ryan-transfer-preview h3,.ryan-transfer-recovery h3,.ryan-transfer-sync h3{margin-top:0!important;text-transform:lowercase!important}
      .ryan-transfer-conflict{display:grid!important;gap:8px!important;margin-top:8px!important}
      @media(max-width:520px){.ryan-transfer-open{right:6px!important;bottom:6px!important}.ryan-v3-recovery-open{left:6px!important;bottom:68px!important}}
    `;
